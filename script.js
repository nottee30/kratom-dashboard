...
.lightning-path{
    ...
    lightningDash 1.2s linear infinite;

}
.customer-box.gold .lightning-path{
    ...
    drop-shadow(0 0 14px #FFF176);

}
.customer-box.silver .lightning-path{
...
.customer-box.bronze .lightning-path{

    stroke:#cd7f32;

    filter:

    drop-shadow(0 0 6px #cd7f32);

}
.customer-box.last .lightning-path{
...
.lightning-path{
    ...
    lightningFlash .22s infinite alternate;
